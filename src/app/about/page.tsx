  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      <div className="space-y-4 text-gray-700">
        <p>
          Xin chào! Tôi là <strong>Ngô Đăng Khoa</strong>, sinh viên năm 4 ngành
          Công nghệ Thông tin tại Đại học Đà Lạt (MSSV: 2212393, lớp CTK46-PM).
          Tôi đóng vai trò <strong>Frontend Lead</strong> trong các dự án nhóm
          và có niềm đam mê mạnh mẽ với lập trình giao diện web.
        </p>
